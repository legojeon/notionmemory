...
from notionmemory.providers.pi import SPEC as _pi
from notionmemory.providers.opencode import SPEC as _opencode

_REGISTRY: dict[str, ProviderSpec] = {p.name: p for p in (_claude, _codex, _kimi, _pi, _opencode)}
